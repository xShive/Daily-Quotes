...
def register_commands(tree):
    ...
    async def random_quote(interaction: discord.Interaction):
        ...
        channels = await get_channels_from_config(interaction, read_config())
        if channels is None:
    ...
    async def set_source(interaction: discord.Interaction, source_channel: discord.TextChannel):
        update_config(interaction.guild_id, "source_channel", source_channel.id)
    ...
    async def set_target(interaction: discord.Interaction, target_channel: discord.TextChannel):
        update_config(interaction.guild_id, "target_channel", target_channel.id)
